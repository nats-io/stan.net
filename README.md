...
for objects normally generated by the NATS client library.  These constructors
are not recommended for use outside of a test environment.
...
construct a message to test with.
...
public void TestProcessMessage()
{
    ...
    // Application code to handle a message.
    handleMessage(msg);
}
```
